...
class MaidBookingDetailsPage extends ConsumerStatefulWidget {
  ...
  const MaidBookingDetailsPage({super.key, required this.currentBooking});

  @override
  ConsumerState<MaidBookingDetailsPage> createState() => _BookingsPageState();
}

class _BookingsPageState extends ConsumerState<MaidBookingDetailsPage> {
          ...
          PopupMenuButton<String>(
            onSelected: (value) async {
              ...
              if (userRole != null &&
                ...
                final updatedSlots = booking.bookingSlots.map((slot) {
                  if (slot.serviceDate ==
                    ...
                    return slot.copyWith(
                      ...
                      maidId: maid!.id,
                      maidName: maid.name,
                      assignedTime: DateFormat('dd-MM-yyyy HH:mm:ss')
                          .format(DateTime.now()),
                    );
                  }
                  return slot;
                ...
                booking.bookingSlots = updatedSlots;
              }
